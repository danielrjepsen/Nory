        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EventId = table.Column<Guid>(type: "uuid", nullable: false),
                    AppTypeId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventApps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventApps_AppTypes_AppTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGuestAppOpens = table.Column<int>(type: "integer", nullable: false),
                    TotalQrScans = table.Column<int>(type: "integer", nullable: false),
                    TotalSlideshowViews = table.Column<int>(type: "integer", nullable: false),
                    TotalGalleryViews = table.Column<int>(type: "integer", nullable: false),
                    LiveGuestCount = table.Column<int>(type: "integer", nullable: false),
                    FeatureUsage = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventMetrics_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExifData = table.Column<string>(type: "text", nullable: true),
                    EventCategoryDbModelId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.EventCategoryDbModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_EventId_Type",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventMetrics_EventId_PeriodType",
                table: "EventMetrics",
                columns: new[] { "EventId", "PeriodType" });
